...
@Tag(name = "Report", description = "장 컨디션 리포트 및 방문 로그 API")
@RestController
...
public class ReportController {
  ...
  @Operation(
      summary = "리포트 생성/조회",
      description = "타입별(DAILY, WEEKLY, MONTHLY) 장 컨디션 분석 리포트를 생성하거나 조회합니다.")
  @GetMapping("/{type}")
  ...
  /** 리포트 히스토리 조회 */
  @Operation(summary = "리포트 히스토리 조회", description = "사용자의 과거 장 컨디션 리포트 내역을 조회합니다.")
  @GetMapping("/history")
