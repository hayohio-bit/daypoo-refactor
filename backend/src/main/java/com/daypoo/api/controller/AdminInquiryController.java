...
import com.daypoo.api.service.AdminInquiryService;
...
public class AdminInquiryController {
  ...
  public ResponseEntity<Page<AdminInquiryListResponse>> getInquiries(
      ...
      @PageableDefault(
          ...
          Pageable pageable) {
    return ResponseEntity.ok(adminInquiryService.getInquiries(status, search, pageable));
  }
  ...
  public ResponseEntity<AdminInquiryDetailResponse> getInquiryDetail(@PathVariable Long id) {
    return ResponseEntity.ok(adminInquiryService.getInquiryDetail(id));
  }
  ...
  public ResponseEntity<Void> answerInquiry(
    ...
    adminInquiryService.answerInquiry(id, request);
  ...
  public ResponseEntity<String> generateInquiryTestData() {
    adminInquiryService.generateInquiryTestData();
