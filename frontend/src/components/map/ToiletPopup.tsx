...
export function ToiletPopup({
  ...
  return (
    <>
          ...
          <div className="flex items-start justify-between p-5 border-b border-[#eef5f0]">
            <div className="flex-1 pr-2">
              <div className="flex items-center gap-2 mb-2">
                ...
                {toilet.isOpen24h && (
                  <span className="text-xs font-bold px-2 py-1 rounded-full bg-[#e8f3ec] text-[#2D6A4F]">
                    24H
                  </span>
                )}
              </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <m.button
                ...
                whileTap={{ scale: 0.9 }}
                className="w-11 h-11 rounded-full flex items-center justify-center bg-[#f4faf6] text-[#7a9e8a] border border-[#d4e8db]"
              >
                <X size={20} />
              </m.button>
            </div>
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar rounded-b-[20px]">
            <div className="px-5 py-4 flex flex-col gap-3 border-b border-[#eef5f0]">
              <div
                ...
                style={{ color: isWithinRange ? '#2D6A4F' : '#E85D5D' }}
              >
            ...
            <div className="px-5 py-4 border-b border-[#eef5f0]">
              <div className="flex items-center justify-between mb-3">
                <p className="text-sm font-bold text-[#1a2b22]">최근 후기</p>
              </div>
              {loadingReviews ? (
                <div className="flex justify-center py-6">
                  <Loader2 className="animate-spin text-[#7a9e8a]" size={20} />
                </div>
                ...
                <div className="space-y-3">
                    ...
                    <div key={review.id} className="pb-3 border-b last:border-0 border-[#eef5f0]">
                      <div className="flex items-center justify-between mb-1.5">
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-bold text-[#1a2b22]">
                            {review.userName}
                          </span>
                        ...
                        <span className="text-xs text-[#95a99e]">
                  ...
                  >
                    전체 {reviewSummary.reviewCount}개 후기 보기
                  </WaveButtonComponent>
                </div>
              ) : (
      ...
      {showReviewListModal &&
        createPortal(
          <ReviewListModal toilet={toilet} onClose={() => setShowReviewListModal(false)} />,
          document.body,
        )}
    </>
  );
