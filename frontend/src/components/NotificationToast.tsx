...
import { Info, MessageSquare, Star, Trophy, X } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <h3 className="text-sm font-black text-[#1A2B27] leading-tight mb-1">{title}</h3>
        <p className="text-xs text-gray-500 leading-normal line-clamp-2">{message}</p>
      </div>
