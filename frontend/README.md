...
- **PWA:** Vite Plugin PWA (오프라인 지원 및 서비스 워커 캐싱 전략 적용)
...
- **오프라인 지원 및 모바일 PWA:** 서비스 워커 기반의 영속적 자산 캐싱 및 하이브리드 모바일 동작 최적화
...
- **Test Co-location:** 단위 및 컴포넌트 테스트 파일은 대상 소스 파일과 동일한 디렉토리에 나란히 배치합니다. (예: `App.tsx`와 `App.test.tsx`)
